...
CREATE TABLE `adviser` (
  ...
  `summary` varchar(655) COLLATE utf8mb4_unicode_ci NOT NULL,
  `experience` varchar(555) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data untuk tabel `adviser`
--

INSERT INTO `adviser` (`id`, `nama`, `company`, `email`, `summary`, `experience`, `education`, `path`, `created_at`, `updated_at`) VALUES
(1, 'Rigi Pradipta', 'Perusahaan', 'rig@gmail.com', 'Josh graduated from Griffith University in 2002 and has spent the last 7 years working in\r\nthe financial planning industry. From 2007 to early 2012', 'Josh graduated from Griffith University in 2002 and has spent the last 7 years working in\r\nthe financial planning industry. From 2007 to early 2012 J', 'Josh graduated from Griffith University in 2002 and has spent the last 7 years working in\r\nthe financial planning industry. From 2007 to early 2012 J', 'https://i.ibb.co/9NLPKcH/rigi.jpg', NULL, '2020-07-12 18:00:07'),
(2, 'Jimmy Febriadi', 'Global company', 'jim@das.com', 'Josh graduated from Griffith University in 2002 and has spent the last 7 years working in\r\nthe financial planning industry. From 2007 to early 2012 Josh worked for a ‘big four’ bank\r\nin the area of wealth protection for individuals and business.', 'Josh graduated from Griffith University in 2002', 'Josh graduated from Griffith University in 2002', 'https://i.ibb.co/9s16vtF/lmg-logo.png', NULL, '2020-07-15 17:13:33'),
(3, 'Jimmy Febriadi', 'Pocari sweet', 'Jimmy@gmail.com', 'Ensuring businesses can continue in the event owners/key employees suffer disability or\r\npass away prematurely', 'Wealth protection and estate planning\r\nProtecting individuals and families against the financial hardship caused by sickness,\r\ninjury and death.', 'Ensuring businesses can continue in the event owners/key employees suffer disability or\r\npass away prematurely', 'https://i.ibb.co/kKRBz0t/aajims.jpg', NULL, '2020-07-15 00:52:13'),
(4, 'Meiko sari', 'Sari Roti', 'meiko@gmail.com', 'Meiko is an Authorised Representative of Guardianfp Ltd (known as Guardian Advice)\r\nand is authorised to provide you with advice', 'customer service scores\r\nand individual productivity. After a solid career in the banking sector, Josh decided to create\r\nhis own business in order to offer a more personalised service to prospective clients', 'customer service scores\r\nand individual productivity. After a solid career in the banking sector, Josh decided to create\r\nhis own business in order to offer a more personalised service to prospective clients', 'https://i.ibb.co/wyX51p4/meiko.png', NULL, '2020-07-15 00:48:55');
...
INSERT INTO `cabang` (`id`, `nama`, `kota`, `alamat`, `telp`, `created_at`, `updated_at`) VALUES
(13, 'Bandung 1', '3204', 'jalan raya padalarang km 23 Cimahi', '55650011211', NULL, NULL),
(14, 'Tangerang 1', '3671', 'jalan raya serang km 11 kota', '0898887770', NULL, NULL),
(15, 'Bogor', '3271', 'jalan raya kelapa dua bogor', '08787777772', NULL, NULL);
...
(3, '2020_07_11_061255_create_cabang_table', 2),
(4, '2020_07_11_061329_create_adviser_table', 2),
(5, '2020_07_11_103711_add_img_to_adviser_table', 3);
...
(1, 'Admin', 'admin@gmail.com', NULL, '$2y$10$NruHiHWSWqCuxm09a5aHMedi4.lDu/ccsluYaVlD52SnV1nhMqwje', NULL, '2020-07-10 02:55:41', '2020-07-10 02:55:41'),
(2, 'Jimmy Febriadi', 'jimmyfreddi@gmail.com', NULL, '$2y$10$fF.zLcr/cQV9wtomQM3.1e6oHzDhn9ePvYq2a71NurStg80KI750.', NULL, '2020-07-12 02:20:53', '2020-07-12 02:20:53');
...
--
-- AUTO_INCREMENT untuk tabel `adviser`
--
ALTER TABLE `adviser`
